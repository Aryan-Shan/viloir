...
import { getDatabase, ref, set, onDisconnect, onValue ,remove,update,push} from 'https://www.gstatic.com/firebasejs/9.6.1/firebase-database.js';
...
export { auth, database, ref, set, onDisconnect, onValue ,remove,update,push};
